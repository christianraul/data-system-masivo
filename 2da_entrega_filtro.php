...
<body>
    <div class="container">
        ...
        <h3 class="text-center mt-5 mb-3">Lista de Empadronados de la 2da Entrega</h3>
        ...
        $query = sprintf("SELECT idemp, dni, codigo, s100, fsu, fecha, paterno, materno, nombre FROM tblemp WHERE idemp BETWEEN 211 AND 420");
